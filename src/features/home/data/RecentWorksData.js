...
const recentWorks = [
  {
    index: 0,
    title: "FlyxPay - Crypto Transaction Application",
    collabWith: "Flyxcoin.org",
    description:
      "FlyX Pay simplifies crypto transactions using mobile numbers instead of complex wallet addresses, ensuring instant, secure transfers. With a focus on user experience and real-world usability, it bridges crypto technology with everyday use. The platform supports seamless P2P transactions for FlyX Coin and quick business payments. Celebrating its launch with a limited-time airdrop campaign, users can earn free FlyX Coins by completing tasks and engaging with the community. Additionally, the presale offers early access to tokens at discounted rates, inviting investors to join a growing ecosystem with over 1.5 million users. ",
    image: flyx,
    color: "#D6B6FF",
  ...
  },
  {
    ...
    color: "#9CCCF1",
    playstoreLink:
      "https://play.google.com/store/apps/details?id=com.healthy_cart_user",
  ...
  },
  {
    ...
    color: "#D6B6FF",
    playstoreLink:
      "https://play.google.com/store/apps/details?id=com.kurikkalBusinessPark",
    appstoreLink: undefined,
  },
  {
    index: 6,
    ...
    color: "#9CCCF1",
    playstoreLink:
      "http://play.google.com/store/apps/details?id=com.chahel_learning",
    appstoreLink: undefined,
  },
];
